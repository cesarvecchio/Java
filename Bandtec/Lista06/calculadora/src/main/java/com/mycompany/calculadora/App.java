...
public class App extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(lblResultado, javax.swing.GroupLayout.DEFAULT_SIZE, 61, Short.MAX_VALUE)
                .addGap(19, 19, 19))
        );
    ...
    private void btnMultiplicacaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMultiplicacaoActionPerformed
        calculadora.mutiplicacao(
                Double.valueOf(txtValor1.getText()), 
                Double.valueOf(txtValor2.getText()));
        
        lblResultado.setText(calculadora.getResultado().toString());
